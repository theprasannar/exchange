    ...
    const chart = createLightWeightChart(ref, {
      ...
      layout: {
        background: {
          ...
          color: "#13151a", // very dark gray (example)
        },
        textColor: "rgba(255, 255, 255, 0.7)", // softened white
      },
    });

    this.chart = chart;
    this.candleSeries = chart.addCandlestickSeries({
      upColor: "rgba(34, 197, 94, 0.6)", // Tailored green
      downColor: "rgba(239, 68, 68, 0.6)", // Tailored red
      borderVisible: false,
      wickVisible: true,
